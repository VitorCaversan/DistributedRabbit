...
/**
 * Renderiza os itinerários e só mostra o botão Reserve se logado.
 */
function renderItineraries(list) {
  ...
  list.forEach(cruise => {
    ...
    // Só exibe o botão se estiver logado!
    const reserveButton = loggedInUser
...
async function login(){
  ...
  loadItineraries(); // <- Atualiza os cards com botões
}
...
function logout(){
  ...
  loadItineraries(); // <- Atualiza os cards sem botões
}
